...
mtk_get_stats64(struct net_device *dev, struct rtnl_link_stats64 *storage)
{
	struct mtk_mac *mac = netdev_priv(dev);
	struct mtk_hw_stats *hw_stats = mac->hw_stats;
	unsigned int start;
...
static const struct ethtool_ops mtk_ethtool_ops = {
	.get_settings		= mtk_get_link_ksettings,
	.set_settings		= mtk_set_link_ksettings,
...
const struct of_device_id of_mtk_match[] = {
	...
	{ .compatible = "mediatek,leopard-eth", .data = &leopard_data},
	{},
};
