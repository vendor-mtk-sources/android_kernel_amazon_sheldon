...
#define GAME_CTLR_CONSUMER_REPORT_ID 0xF5
...
#define CUSTOM_APP2	0x2e8
#define CUSTOM_APP3	0x2ea
	...
	u8 *data, int size)
{
	...
	case CONSUMER_REPORT_ID:
		...
		if (is_amazon_ble_game_controller(hdev))
			break;
	case GAME_CTLR_CONSUMER_REPORT_ID: /* Specially added for BLE Game Controller */
